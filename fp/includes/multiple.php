...
?>
	...
	<div>	
		<fieldset>
			<legend>What Books Are You Interested In?</legend>
			<input type="checkbox" name="Interested_In[]" value="Education" tabindex="40" /> Education <br />
			<input type="checkbox" name="Interested_In[]" value="Novel" /> Novel <br />
			<input type="checkbox" name="Interested_In[]" value="History" /> History <br />
			<input type="checkbox" name="Interested_In[]" value="Art" /> Art <br />
